(function(Hiof, undefined) {
    ...
    Hiof.coverGenerateMarkupPicture = function(data) {
        ...
        var coverWrapper = document.createElement('div'),
            photoWrapper = document.createElement('img'),
            blurWrapper = document.createElement('img'),
            windowWidth = $(window).width(),
        ...
        //console.log(photoSrcSet);
        //console.log(photoBlurredSrcSet);


        $(photoWrapper).attr('srcset', photoSrcSet);
        $(blurWrapper).attr('srcset', photoBlurredSrcSet);
        //$(coverWrapper).addClass('height-' + data[2000].imgHeight);


        //if(windowWidth < 400){
        //    $(coverWrapper).addClass('height-' + data[400].imgHeight );
        //    //$(photoWrapper).addClass('height-' + data[400].imgHeight);
        //    //$(blurWrapper).addClass('height-' + data[400].imgHeight);
        //}else if ((windowWidth > 400) && (windowWidth < 500)){
        //    $(coverWrapper).addClass('height-' + data[500].imgHeight);
        //    //$(photoWrapper).addClass('height-' + data[500].imgHeight);
        //    //$(blurWrapper).addClass('height-' + data[500].imgHeight);
        //}else if ((windowWidth > 500) && (windowWidth < 600)){
        //    $(coverWrapper).addClass('height-' + data[600].imgHeight);
        //    //$(photoWrapper).addClass('height-' + data[600].imgHeight);
        //    //$(blurWrapper).addClass('height-' + data[600].imgHeight);
        // 
        //}else if ((windowWidth > 600) && (windowWidth < 800)){
        //    $(coverWrapper).addClass('height-' + data[800].imgHeight);
        //    //$(photoWrapper).addClass('height-' + data[800].imgHeight);
        //    //$(blurWrapper).addClass('height-' + data[800].imgHeight);
        //   
        //}else if ((windowWidth > 800) && (windowWidth < 1000)){
        //    $(coverWrapper).addClass('height-' + data[1000].imgHeight);
        //    //$(photoWrapper).addClass('height-' + data[1000].imgHeight);
        //    //$(blurWrapper).addClass('height-' + data[1000].imgHeight);
        //  
        //}else if ((windowWidth > 1000) && (windowWidth < 1200)){
        //    $(coverWrapper).addClass('height-' + data[1200].imgHeight);
        //    //$(photoWrapper).addClass('height-' + data[1200].imgHeight);
        //    //$(blurWrapper).addClass('height-' + data[1200].imgHeight);
        //    
        //}else if ((windowWidth > 1200) && (windowWidth < 1600)){
        //    $(coverWrapper).addClass('height-' + data[1600].imgHeight);
        //    //$(photoWrapper).addClass('height-' + data[1600].imgHeight);
        //    //$(blurWrapper).addClass('height-' + data[1600].imgHeight);
        //   
        //}else if (windowWidth > 1600){
        //    $(coverWrapper).addClass('height-' + data[2000].imgHeight);
        //    //$(photoWrapper).addClass('height-' + data[2000].imgHeight);
        //    //$(blurWrapper).addClass('height-' + data[2000].imgHeight);
        //}
        ...
        $(coverWrapper).append(photoWrapper);
        $(coverWrapper).append(blurWrapper);
        //console.log($(coverWrapper));
        $('#main').prepend(coverWrapper);
